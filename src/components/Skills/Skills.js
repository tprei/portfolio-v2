...
function Card(props) {
    const {value} = props;
    return (
        <div className='border-2 border-green text-green p-2 m-2 rounded-lg'>{value}</div>
    );
}
...
export const Skills = (props) => {
    ...
    return (
        <div className='flex flex-col md:flex-row gap-4 justify-center'>
            ...
            <div className='flex md:w-4/5 align-start flex-wrap justify-start content-start flex-shrink-0 border-2 border-red'>
